...
namespace WABA360Dialog.PartnerClient.Payloads
{
    ...
    {
        public GetPartnerChannelsRequest(string partnerId, int limit = 20, int offset = 0, string sort = "-", object filters = null) : base($"partners/{partnerId}/channels", HttpMethod.Get)
        {
            PartnerId = partnerId;
            Limit = limit;
            Offset = offset;
